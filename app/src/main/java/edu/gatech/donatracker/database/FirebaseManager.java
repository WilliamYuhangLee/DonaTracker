...
public class FirebaseManager {
    ...
    private static <T> void getObject(Activity activity, Class<T> type, QueryResultHandler<T> handler,
        ...
        docRef.get()
                ...
                .addOnFailureListener(activity, e -> Log.e(activity.getClass().getSimpleName(),
    ...
    private static <T> void getObjects(Activity activity, Class<T> type, List<T> listToFillObjects,
        ...
        colRef.get()
                ...
                .addOnFailureListener(activity, e -> Log.e(activity.getClass().getSimpleName(), "Collection [" + colRef.getId() + "] fetch failed!", e));
    }
    ...
    public static <T> void uploadObjects(Activity activity, List<T> listToUpload, Function<T, Map<String, Object>>
        ...
        batch.commit().addOnSuccessListener(activity, aVoid -> Log.d(activity.getClass().getSimpleName(), String.format("Collection [%s] upload successful.", colRef.getId()))).addOnFailureListener(activity, e -> Log.e(activity.getClass().getSimpleName(), String.format("Collection [%s] upload failed!", colRef.getId()), e));
    }
    ...
    public static void deleteFields(Activity activity, DocumentReference docRef, String... fieldNames) {
        ...
        docRef.update(fieldsToDelete).addOnSuccessListener(activity, aVoid -> Log.d(activity.getClass().getSimpleName(),
                String.format("%s[%s] fields delete successful.", docRef.getParent().getId(), docRef.getId()))).addOnFailureListener(activity, e -> Log.e(activity.getClass().getSimpleName(),
    ...
    public static void addElementsToArrayField(Activity activity, DocumentReference docRef, String arrayFieldName,
        ...
        docRef.update(arrayFieldName, FieldValue.arrayUnion(elements))
                .addOnSuccessListener(activity, v -> Log.d(activity.getClass().getSimpleName(), String.format("%s[%s].%s update successful.",
                        docRef.getParent().getId(), docRef.getId(), arrayFieldName))).addOnFailureListener(activity, e -> Log.e(activity.getClass().getSimpleName(), String.format("%s[%s].%s update failed!",
