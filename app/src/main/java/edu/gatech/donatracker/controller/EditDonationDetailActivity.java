...
public class EditDonationDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentDonation != null) {
            ...
            editTextValueInUSD.setText(Double.toString(currentDonation.getValueInUSD()));
            editTextComment.setText(currentDonation.getComments());
            editing = true;
        } else {
            currentDonation = new Donation(model.getCurrentLocation());
            editing = false;
        }
    }
    ...
    public void onClickSaveDonation(View view) {
        ...
        if (!editing) {
            model.getCurrentLocation().addDonation(currentDonation);
